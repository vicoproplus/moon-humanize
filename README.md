...
> MoonBit 包已发布到 [mooncakes.io](https://mooncakes.io)：[`vicoproplus/moon-humanize`](https://mooncakes.io/#/package/vicoproplus/moon-humanize)。
>
> 在 MoonBit 项目中添加依赖：
>
> ```bash
...
>
> // 或直接引用内部 humanize 模块
> import "vicoproplus/moon-humanize/src/humanize"
> ```
